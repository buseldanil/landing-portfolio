...
const heroParallax = () => {
  ...
  const main = document.querySelector('.hero-phone-main');
  const left = document.querySelector('.hero-phone-left');
  const right = document.querySelector('.hero-phone-right');
  const topFloat = document.querySelector('.hero-floating-top');
  const bottomFloat = document.querySelector('.hero-floating-bottom');
  ...
  if (left) {
    left.style.transform = `translateY(${y * 0.08}px) rotate(-10deg)`;
  }
  ...
  if (topFloat) {
    topFloat.style.transform = `translateY(${y * 0.03}px)`;
  }

  if (bottomFloat) {
    bottomFloat.style.transform = `translateY(${y * -0.03}px)`;
  }
};
